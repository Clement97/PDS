...
-- insert into Reservation(idAnimal,idClient,dateReservation,dateDebut,dateFin,montant,valide) values (1,1,'2016-05-19','2016-06-21','2016-06-25',);
-- insert into Reservation(idAnimal,idClient,dateReservation,dateDebut,dateFin,montant,valide) values (2,2,'2016-04-26','2016-05-21','2016-05-29',);
-- insert into Reservation(idAnimal,idClient,dateReservation,dateDebut,dateFin,montant,valide) values (3,1,'2016-03-24','2016-02-11','2016-03-25',);
-- insert into Reservation(idAnimal,idClient,dateReservation,dateDebut,dateFin,montant,valide) values (4,3,'2016-02-20','2016-02-21','2016-06-28',);
-- insert into Reservation(idAnimal,idClient,dateReservation,dateDebut,dateFin,montant,valide) values (5,4,'2016-01-09','2016-01-21','2016-02-12',);
-- insert into Reservation(idAnimal,idClient,dateReservation,dateDebut,dateFin,montant,valide) values (1,1,'2016-11-11','2016-12-11','2016-12-06',);
-- insert into Reservation(idAnimal,idClient,dateReservation,dateDebut,dateFin,montant,valide) values (2,2,'2016-01-01','2016-01-07','2016-01-09',);
-- insert into Reservation(idAnimal,idClient,dateReservation,dateDebut,dateFin,montant,valide) values (3,1,'2016-05-31','2016-06-05','2016-06-25',);
