...
<?php
	...
	echo("	<table>
				...
				<tr>	
					...
					<td><a href=\"espacePrive.php?actionA=reserver&amp;idAnimal=".$donnees['idAnimal']."\"><button type=\"button\" >R</button> </td></td>
					<td><a href=\"espacePrive.php?actionA=modifier&amp;idAnimal=".$donnees['idAnimal']."\"><button type=\"button\" >M</button> </td></td>
	...
	echo("
				<tr>	
					...
					<td>".est1($donnees['carnetVaccinationValide'])."</td>
					<td>".$donnees['dateUpload']."</td>
					<td><a href=\"espacePrive.php?actionA=reserver&amp;idAnimal=".$donnees['idAnimal']."\"><button type=\"button\" >R</button> </td>
					<td><a href=\"espacePrive.php?actionA=modifier&amp;idAnimal=".$donnees['idAnimal']."\"><button type=\"button\" >M</button> </td>
					<td><button type=\"button\" name=".$donnees['idAnimal'].">X</button> </td>
