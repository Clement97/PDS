<div id="inscription">
            <div id="titre">
                <h1> Page de création de compte pour salarié </h1>
            </div>
            <div id="contenu">
                <div class="insbloc">
                    <p> 
                ...
                <div class="insbloc">
                    <form method="post" action="espacePrive.php?creation=1" onsubmit="return (loginOK && passwordOK && confPasswordOK && nomOK && prenomOK); ">
                        <fieldset>
        ...
        <?php include("Script_PHP/Administrateur/traitementCreation.php"); ?>
